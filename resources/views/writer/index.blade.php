    ...
    <div class="container">
        ...
        <div class="d-flex">
            <div class="col-md-10">
                        ...
                        @foreach ($writers as $writer)
                            <div class="col position-relative">
                                <div class="card h-100">
                                    <img class="card-image-top" src="{{ $writer->image_url }}" alt="{{ $writer->name }}"
                                        style="width:100%">
                                    <div class="card-body d-flex flex-column justify-content-between">
                                        <a class="card-title fw-bold fs-5 stretched-link text-black text-decoration-none m-0"
                                            href="{{ route('writers.show', ['writer' => $writer->id]) }}">{{ Str::limit($writer->name, 30, '...') }}</a>
                ...
                @else
                    <h3 class="text-center">No writers found.</h3>
                @endif
            </div>
